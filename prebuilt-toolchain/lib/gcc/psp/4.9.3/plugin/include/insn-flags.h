...
#define HAVE_allegrex_madd (TARGET_ALLEGREX)
#define HAVE_allegrex_msub (TARGET_ALLEGREX)
#define HAVE_sminsi3 (TARGET_ALLEGREX)
#define HAVE_smaxsi3 (TARGET_ALLEGREX)
#define HAVE_allegrex_bitrev (TARGET_ALLEGREX)
#define HAVE_allegrex_clo (TARGET_ALLEGREX)
#define HAVE_allegrex_sync (TARGET_ALLEGREX)
#define HAVE_allegrex_cache (TARGET_ALLEGREX)
#define HAVE_allegrex_ceil_w_s (TARGET_ALLEGREX)
#define HAVE_allegrex_floor_w_s (TARGET_ALLEGREX)
#define HAVE_allegrex_round_w_s (TARGET_ALLEGREX)
...
#define HAVE_ffssi2 (ISA_HAS_CLZ_CLO)
#define HAVE_ffsdi2 ((ISA_HAS_CLZ_CLO) && (TARGET_64BIT))
#define HAVE_rotlsi3 (ISA_HAS_ROR)
#define HAVE_rotldi3 ((ISA_HAS_ROR) && (TARGET_64BIT))
...
#define HAVE_ctzsi2 (TARGET_ALLEGREX)
#define HAVE_allegrex_cto (TARGET_ALLEGREX)
...
extern rtx        gen_allegrex_madd                   (rtx, rtx, rtx);
extern rtx        gen_allegrex_msub                   (rtx, rtx, rtx);
extern rtx        gen_sminsi3                         (rtx, rtx, rtx);
extern rtx        gen_smaxsi3                         (rtx, rtx, rtx);
extern rtx        gen_allegrex_bitrev                 (rtx, rtx);
extern rtx        gen_allegrex_clo                    (rtx, rtx);
extern rtx        gen_allegrex_sync                   (void);
extern rtx        gen_allegrex_cache                  (rtx, rtx);
extern rtx        gen_allegrex_ceil_w_s               (rtx, rtx);
extern rtx        gen_allegrex_floor_w_s              (rtx, rtx);
extern rtx        gen_allegrex_round_w_s              (rtx, rtx);
...
extern rtx        gen_allegrex_cto                    (rtx, rtx);
