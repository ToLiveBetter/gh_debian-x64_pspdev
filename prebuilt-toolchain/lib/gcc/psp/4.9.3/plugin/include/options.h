...
enum opt_code
{
  ...
  OPT_flifetime_dse = 712,                   /* -flifetime-dse */
  OPT_flive_range_shrinkage = 713,           /* -flive-range-shrinkage */
  ...
  OPT_flto_partition_1to1 = 723,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 724,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 725,              /* -flto-partition=max */
  OPT_flto_partition_none = 726,             /* -flto-partition=none */
  OPT_flto_report = 727,                     /* -flto-report */
  OPT_flto_report_wpa = 728,                 /* -flto-report-wpa */
  OPT_flto_ = 729,                           /* -flto= */
  ...
  OPT_fmem_report_wpa = 740,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 741,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 742,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 743,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 744,                /* -fmessage-length= */
  OPT_fmodule_private = 745,                 /* -fmodule-private */
  OPT_fmodulo_sched = 746,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 747,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 748,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 749,                  /* -fms-extensions */
  /* OPT_fmudflap = 750, */                  /* -fmudflap */
  /* OPT_fmudflapir = 751, */                /* -fmudflapir */
  /* OPT_fmudflapth = 752, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 753, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 754, */                  /* -fnew-abi */
  OPT_fnext_runtime = 755,                   /* -fnext-runtime */
  OPT_fnil_receivers = 756,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 757, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 758,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 759,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 760, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 761,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 762,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 763,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 764,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 765,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 766,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 767,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 768,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 769,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 770,             /* -fomit-frame-pointer */
  OPT_fopenmp = 771,                         /* -fopenmp */
  OPT_fopenmp_simd = 772,                    /* -fopenmp-simd */
  OPT_foperator_names = 773,                 /* -foperator-names */
  OPT_fopt_info = 774,                       /* -fopt-info */
  OPT_fopt_info_ = 775,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 776, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 777,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 778,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 779,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 780, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 781,              /* -foutput-class-dir= */
  OPT_fpack_derived = 782,                   /* -fpack-derived */
  OPT_fpack_struct = 783,                    /* -fpack-struct */
  OPT_fpack_struct_ = 784,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 785,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 786,              /* -fpcc-struct-return */
  OPT_fpch_deps = 787,                       /* -fpch-deps */
  OPT_fpch_preprocess = 788,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 789,                     /* -fpeel-loops */
  OPT_fpeephole = 790,                       /* -fpeephole */
  OPT_fpeephole2 = 791,                      /* -fpeephole2 */
  OPT_fpermissive = 792,                     /* -fpermissive */
  OPT_fpic = 793,                            /* -fpic */
  OPT_fpie = 794,                            /* -fpie */
  OPT_fplan9_extensions = 795,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 796,                    /* -fplugin-arg- */
  OPT_fplugin_ = 797,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 798,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 799,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 800,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 801,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 802,                   /* -fpreprocessed */
  OPT_fpretty_templates = 803,               /* -fpretty-templates */
  OPT_fprofile = 804,                        /* -fprofile */
  OPT_fprofile_arcs = 805,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 806,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 807,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 808,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 809,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 810,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 811,                 /* -fprofile-report */
  OPT_fprofile_use = 812,                    /* -fprofile-use */
  OPT_fprofile_use_ = 813,                   /* -fprofile-use= */
  OPT_fprofile_values = 814,                 /* -fprofile-values */
  OPT_fprotect_parens = 815,                 /* -fprotect-parens */
  OPT_frandom_seed = 816,                    /* -frandom-seed */
  OPT_frandom_seed_ = 817,                   /* -frandom-seed= */
  OPT_frange_check = 818,                    /* -frange-check */
  OPT_freal_4_real_10 = 819,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 820,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 821,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 822,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 823,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 824,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 825,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 826,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 827,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 828,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 829,                /* -frecord-marker=8 */
  OPT_frecursive = 830,                      /* -frecursive */
  OPT_freduced_reflection = 831,             /* -freduced-reflection */
  OPT_free = 832,                            /* -free */
  OPT_freg_struct_return = 833,              /* -freg-struct-return */
  /* OPT_fregmove = 834, */                  /* -fregmove */
  OPT_frename_registers = 835,               /* -frename-registers */
  OPT_freorder_blocks = 836,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 837,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 838,              /* -freorder-functions */
  OPT_frepack_arrays = 839,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 840,           /* -freplace-objc-classes */
  OPT_frepo = 841,                           /* -frepo */
  OPT_frequire_return_statement = 842,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 843,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 844, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 845,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 846,                    /* -fresolution= */
  OPT_frounding_math = 847,                  /* -frounding-math */
  OPT_frtti = 848,                           /* -frtti */
  OPT_fsanitize_ = 849,                      /* -fsanitize= */
  OPT_fsaw_java_file = 850,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 851,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 852,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 853,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 854,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 855,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 856,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 857,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 858,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 859,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 860,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 861,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 862,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 863,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 864,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 865,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 866,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 867,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 868, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 869,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 870,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 871,              /* -fsecond-underscore */
  OPT_fsection_anchors = 872,                /* -fsection-anchors */
  /* OPT_fsee = 873, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 874,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 875,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 876, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 877,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 878,          /* -fselective-scheduling2 */
  OPT_fshort_double = 879,                   /* -fshort-double */
  OPT_fshort_enums = 880,                    /* -fshort-enums */
  OPT_fshort_wchar = 881,                    /* -fshort-wchar */
  OPT_fshow_column = 882,                    /* -fshow-column */
  OPT_fshrink_wrap = 883,                    /* -fshrink-wrap */
  OPT_fsign_zero = 884,                      /* -fsign-zero */
  OPT_fsignaling_nans = 885,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 886,               /* -fsigned-bitfields */
  OPT_fsigned_char = 887,                    /* -fsigned-char */
  OPT_fsigned_zeros = 888,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 889,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 890,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 891,               /* -fsource-filename= */
  OPT_fsource_ = 892,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 893,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 894,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 895,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 896, */                 /* -fsquangle */
  OPT_fstack_arrays = 897,                   /* -fstack-arrays */
  /* OPT_fstack_check = 898, */              /* -fstack-check */
  OPT_fstack_check_ = 899,                   /* -fstack-check= */
  OPT_fstack_limit = 900,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 901,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 902,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 903,                /* -fstack-protector */
  OPT_fstack_protector_all = 904,            /* -fstack-protector-all */
  OPT_fstack_protector_strong = 905,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 906,                   /* -fstack-reuse= */
  OPT_fstack_usage = 907,                    /* -fstack-usage */
  OPT_fstats = 908,                          /* -fstats */
  OPT_fstore_check = 909,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 910, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 911,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 912,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 913,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 914, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 915,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 916,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 917,                    /* -fsyntax-only */
  OPT_ftabstop_ = 918,                       /* -ftabstop= */
  /* OPT_ftarget_help = 919, */              /* -ftarget-help */
  OPT_ftarget_ = 920,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 921,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 922, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 923,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 924,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 925, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 926,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 927,             /* -fthreadsafe-statics */
  OPT_ftime_report = 928,                    /* -ftime-report */
  OPT_ftls_model_ = 929,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 930,               /* -ftoplevel-reorder */
  OPT_ftracer = 931,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 932,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 933,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 934,                  /* -ftrapping-math */
  OPT_ftrapv = 935,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 936,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 937,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 938,                       /* -ftree-ccp */
  OPT_ftree_ch = 939,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 940,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 941,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 942,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 943,                /* -ftree-copyrename */
  OPT_ftree_cselim = 944,                    /* -ftree-cselim */
  OPT_ftree_dce = 945,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 946,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 947,                       /* -ftree-dse */
  OPT_ftree_forwprop = 948,                  /* -ftree-forwprop */
  OPT_ftree_fre = 949,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 950,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 951,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 952,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 953,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 954,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 955,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 956, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 957,             /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 958,            /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 959,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 960,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 961,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 962,                   /* -ftree-phiprop */
  OPT_ftree_pre = 963,                       /* -ftree-pre */
  OPT_ftree_pta = 964,                       /* -ftree-pta */
  OPT_ftree_reassoc = 965,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 966, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 967,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 968,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 969,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 970,                      /* -ftree-slsr */
  OPT_ftree_sra = 971,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 972, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 973, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 974,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 975,                /* -ftree-tail-merge */
  OPT_ftree_ter = 976,                       /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 977, */   /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 978,                 /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 979, */ /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 980,                       /* -ftree-vrp */
  OPT_funderscoring = 981,                   /* -funderscoring */
  OPT_funit_at_a_time = 982,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 983,               /* -funroll-all-loops */
  OPT_funroll_loops = 984,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 985,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 986,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 987,             /* -funsigned-bitfields */
  OPT_funsigned_char = 988,                  /* -funsigned-char */
  OPT_funswitch_loops = 989,                 /* -funswitch-loops */
  OPT_funwind_tables = 990,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 991,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 992,                   /* -fuse-boehm-gc */
  ...
  OPT_fuse_linker_plugin = 998,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 999,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1000,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1001,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1002,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1003,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1004, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1005,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1006,                   /* -fverbose-asm */
  /* OPT_fversion = 1007, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1008,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1009,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1010,                   /* -fvisibility= */
  OPT_fvpt = 1011,                           /* -fvpt */
  /* OPT_fvtable_gc = 1012, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1013, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1014,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1015,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1016,                     /* -fvtv-debug */
  OPT_fweak = 1017,                          /* -fweak */
  OPT_fweb = 1018,                           /* -fweb */
  /* OPT_fwhole_file = 1019, */              /* -fwhole-file */
  OPT_fwhole_program = 1020,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1021,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1022,             /* -fworking-directory */
  OPT_fwpa = 1023,                           /* -fwpa */
  OPT_fwpa_ = 1024,                          /* -fwpa= */
  OPT_fwrapv = 1025,                         /* -fwrapv */
  ...
  OPT_mcode_readable_ = 1077,                /* -mcode-readable= */
  OPT_mdebug = 1078,                         /* -mdebug */
  OPT_mdebugd = 1079,                        /* -mdebugd */
  OPT_mdivide_breaks = 1080,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1081,                  /* -mdivide-traps */
  OPT_mdmx = 1082,                           /* -mdmx */
  OPT_mdouble_float = 1083,                  /* -mdouble-float */
  OPT_mdsp = 1084,                           /* -mdsp */
  OPT_mdspr2 = 1085,                         /* -mdspr2 */
  OPT_meb = 1086,                            /* -meb */
  OPT_mel = 1087,                            /* -mel */
  OPT_membedded_data = 1088,                 /* -membedded-data */
  OPT_meva = 1089,                           /* -meva */
  OPT_mexplicit_relocs = 1090,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1091,                  /* -mextern-sdata */
  OPT_mfix_24k = 1092,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1093,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1094,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1095,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1096,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1097,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1098,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1099,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1100,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1101,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1102,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1103,                 /* -mfp-exceptions */
  OPT_mfp32 = 1104,                          /* -mfp32 */
  OPT_mfp64 = 1105,                          /* -mfp64 */
  OPT_mfused_madd = 1106,                    /* -mfused-madd */
  OPT_mgp32 = 1107,                          /* -mgp32 */
  OPT_mgp64 = 1108,                          /* -mgp64 */
  OPT_mgpopt = 1109,                         /* -mgpopt */
  OPT_mhard_float = 1110,                    /* -mhard-float */
  OPT_mimadd = 1111,                         /* -mimadd */
  OPT_minterlink_compressed = 1112,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1113,              /* -minterlink-mips16 */
  OPT_mips = 1114,                           /* -mips */
  OPT_mips16 = 1115,                         /* -mips16 */
  OPT_mips3d = 1116,                         /* -mips3d */
  OPT_mllsc = 1117,                          /* -mllsc */
  OPT_mlocal_sdata = 1118,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1119,                    /* -mlong-calls */
  OPT_mlong32 = 1120,                        /* -mlong32 */
  OPT_mlong64 = 1121,                        /* -mlong64 */
  OPT_mmad = 1122,                           /* -mmad */
  OPT_mmcount_ra_address = 1123,             /* -mmcount-ra-address */
  OPT_mmcu = 1124,                           /* -mmcu */
  OPT_mmemcpy = 1125,                        /* -mmemcpy */
  OPT_mmicromips = 1126,                     /* -mmicromips */
  OPT_mmt = 1127,                            /* -mmt */
  OPT_mnan_ = 1128,                          /* -mnan= */
  OPT_mno_float = 1129,                      /* -mno-float */
  OPT_mno_flush_func = 1130,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1131,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1132,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1133,                     /* -mno-mips3d */
  OPT_mpaired_single = 1134,                 /* -mpaired-single */
  OPT_mplt = 1135,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1136,     /* -mpreferred-stack-boundary= */
  OPT_mr10k_cache_barrier_ = 1137,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1138,               /* -mrelax-pic-calls */
  OPT_mshared = 1139,                        /* -mshared */
  OPT_msingle_float = 1140,                  /* -msingle-float */
  OPT_msmartmips = 1141,                     /* -msmartmips */
  OPT_msoft_float = 1142,                    /* -msoft-float */
  OPT_msplit_addresses = 1143,               /* -msplit-addresses */
  OPT_msym32 = 1144,                         /* -msym32 */
  OPT_msynci = 1145,                         /* -msynci */
  OPT_mtune_ = 1146,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1147,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1148,                          /* -mvirt */
  OPT_mvr4130_align = 1149,                  /* -mvr4130-align */
  OPT_mxgot = 1150,                          /* -mxgot */
  OPT_n = 1151,                              /* -n */
  OPT_no_canonical_prefixes = 1152,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1153,              /* -no-integrated-cpp */
  OPT_noasmopt = 1154,                       /* -noasmopt */
  ...
  OPT_quiet = 1180,                          /* -quiet */
  OPT_r = 1181,                              /* -r */
  OPT_remap = 1182,                          /* -remap */
  OPT_s = 1183,                              /* -s */
  OPT_s_bc_abi = 1184,                       /* -s-bc-abi */
  OPT_save_temps = 1185,                     /* -save-temps */
  OPT_save_temps_ = 1186,                    /* -save-temps= */
  OPT_shared = 1187,                         /* -shared */
  OPT_shared_libgcc = 1188,                  /* -shared-libgcc */
  /* OPT_specs = 1189, */                    /* -specs */
  OPT_specs_ = 1190,                         /* -specs= */
  OPT_static = 1191,                         /* -static */
  OPT_static_libasan = 1192,                 /* -static-libasan */
  OPT_static_libgcc = 1193,                  /* -static-libgcc */
  OPT_static_libgcj = 1194,                  /* -static-libgcj */
  OPT_static_libgfortran = 1195,             /* -static-libgfortran */
  OPT_static_libgo = 1196,                   /* -static-libgo */
  OPT_static_liblsan = 1197,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1198,               /* -static-libstdc++ */
  OPT_static_libtsan = 1199,                 /* -static-libtsan */
  OPT_static_libubsan = 1200,                /* -static-libubsan */
  /* OPT_std_c__03 = 1201, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1202, */                /* -std=c++0x */
  OPT_std_c__11 = 1203,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1204, */                /* -std=c++14 */
  ...
  /* OPT_std_gnu__14 = 1221, */              /* -std=gnu++14 */
  ...
  OPT_time = 1238,                           /* -time */
  OPT_time_ = 1239,                          /* -time= */
  OPT_traditional = 1240,                    /* -traditional */
  OPT_traditional_cpp = 1241,                /* -traditional-cpp */
  OPT_trigraphs = 1242,                      /* -trigraphs */
  OPT_u = 1243,                              /* -u */
  OPT_undef = 1244,                          /* -undef */
  OPT_v = 1245,                              /* -v */
  OPT_version = 1246,                        /* -version */
  OPT_w = 1247,                              /* -w */
  OPT_wrapper = 1248,                        /* -wrapper */
  OPT_x = 1249,                              /* -x */
  OPT_z = 1250,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
